...
export const stateToLGA: { [key: string]: string[] } = {
    "Abia": ["Aba North", "Aba South", "Arochukwu", "Bende", "Ikawuno", "Ikwuano", "Isiala Ngwa North", "Isiala Ngwa South", "Isuikwuato", "Umuahia North", "Umuahia South", "Umu Nneochi"],
    ...
    "Ebonyi": ["Abakaliki", "Afikpo North", "Afikpo South", "Ebonyi", "Ezza North", "Ezza South", "Ikwo", "Ishielu", "Ivo", "Izzi", "Ohaukwu", "Onicha", "Ohaozara"],
    ...
    "Jigawa": [
        ...
        "Kazaure", "Kiri Kasamma", "Maigatari", "Malam Madori", "Miga", "Ringim", "Roni", 
    ...
    "Niger": [
        ...
        "Magama", "Mariga", "Mashegu", "Mokwa", "Muya", "Paikoro", "Rafi", "Rijau", "Shiroro", "Suleja", "Tafa", "Wushishi"
    ],
    "Ogun": [
    ...
    "Osun": [
        "Aiyedaade", "Aiyedire", "Atakunmosa East", "Atakunmosa West", "Boluwaduro", "Boripe", "Ede North", "Ede South",
        "Egbedore", "Ejigbo", "Ife Central", "Ife East", "Ife North", "Ife South", "Ifedayo", "Ifelodun", "Ila", "Ilesa East",
        "Ilesa West", "Irepodun", "Irewole", "Isokan", "Iwo", "Obokun", "Odo Otin", "Ola Oluwa", "Olorunda", "Oriade", "Orolu",
        "Osogbo"
    ],  
    "Oyo": [
        ...
        "Iseyin", "Itesiwaju", "Iwajowa", "Kajola", "Lagelu", "Ogbomosho North", "Ogbomosho South", "Ogo Oluwa", "Olorunsogo",
